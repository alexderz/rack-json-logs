...
Gem::Specification.new do |gem|
  gem.name          = 'grav_rack-json-logs'
  gem.version       = Rack::JsonLogs::VERSION
  gem.authors       = ['Kenneth Ballenegger', 'Alex Derzhi']
  gem.email         = ['kenneth@ballenegger.com', 'alex.derzhi@gravitant.com']
  ...
  gem.homepage      = 'https://github.com/alexderz/rack-json-logs'
